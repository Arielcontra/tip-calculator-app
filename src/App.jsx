...
function App() {
  ...
  return (
          ...
          <div className="wrapperSlider-Display">
            <div className="slider">
              <div className="wrapperBill">
                ...
                <input type="number" className="totalBill" placeholder="0"  id="totalBill" />
              </div>
              ...
              <div className="wrapperPeople">
                ...
                <input type="number" className="people" placeholder='0' />
              </div>
            </div>
                ...
                <div className="wrapperResult">
                  <div className="wrapperTip">
                    ...
                    <div className="wrapperDisplayTip">
                      <h1 className="displayTip">$0.00</h1>
                    </div>
                  </div>
                  <div className="wrapperTotal">
                    ...
                    <div className="wrapperDisplayTotal">
                      <h1 className="displayTotal">$0.00</h1>
                    </div>
                  </div>
                </div>
    ...
    Coded by <a href="#">Ariel Contreras</a>.</p>
        </footer>
      </div>
